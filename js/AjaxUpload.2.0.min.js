(function(){
	...
	function M(O){
		...
		var Q=0,P=0;
		do{
			Q+=O.offsetTop||0;P+=O.offsetLeft||0
		}
	...
	function A(Q){
		...
		O=R+Q.offsetHeight;
		return{
			left:S,right:P,top:R,bottom:O
		}
	}
	function I(O){
		if(!O.pageX&&O.clientX){
			return{
				x:O.clientX+G.body.scrollLeft+G.documentElement.scrollLeft,y:O.clientY+G.body.scrollTop+G.documentElement.scrollTop
			}
		}
		return{
			x:O.pageX,y:O.pageY
